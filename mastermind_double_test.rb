class Game
    ...
    def codebreaker_game
        ...
        # puts computer_choice_codebreaker
            ...
            point_checker
            puts "You got this many white points: #{@@white_point}."
            puts "And you got this many black points: #{@@black_point}."

         
                response = ""
                if @@codebreaker_game_counter != 12 
                    while response != "k" || response !="cheat" 
                            puts "Type 'k' to continue, or 'cheat' to see what the computer answered."
                            response = gets.chomp
                            
                            if response == "k"
                                break
                            elsif response == "cheat"
                                puts "Computer Computer chose:"
                                puts @computer_choice_codebreaker
                                break
                            end
            ...
            @@codebreaker_array.each_with_index do |user_choice, user_slot|
                @computer_choice_codebreaker.each_with_index do |computer_choice, computer_slot|
                    if user_choice == computer_choice && user_slot == computer_slot  
                        ...
                        game_match_checker +=1
                            if game_match_checker == 4
                                @@codebreaker_game_counter = 12
